...
{
    public partial class frmDeleteEnters : Form
    {
        public frmDeleteEnters()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (textBox1.Text != "")
                {
                    ...
                    if (Found == true)
                    {
                        objCommand.CommandText = "Delete From EnterDetails Where EnterID=" + Convert.ToInt64(textBox1.Text) + "";
                        objCommand.ExecuteNonQuery();
                        objCommand.Dispose();
                        objCommand.CommandText = "Delete From EnterDocuments Where Enterid=" + Convert.ToInt64(textBox1.Text) + "";
                        objCommand.ExecuteNonQuery();
